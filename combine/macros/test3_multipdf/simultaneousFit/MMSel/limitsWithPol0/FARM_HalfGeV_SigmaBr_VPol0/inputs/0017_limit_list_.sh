...
cd -
/nfs/user/ajafari/work/CMSSW_7_1_5/bin/slc6_amd64_gcc481/combine -M Asymptotic /nfs/user/ajafari/work/CMSSW_7_1_5/src/HiggsAnalysis/CombinedLimit/macros/test3_multipdf/simultaneousFit/MMSel/limitsWithPol0/hamb_shape_SigmaBr_ws.txt -m 33.5
