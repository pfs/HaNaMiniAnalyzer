...
from ROOT import kGray, kGreen, kOrange, kRed, kBlack, kCyan, kBlue, kAzure
...
cDiMu = CutInfo( "Trigger" , Cuts["Trigger"],"hltWeight_Mu17Mu8_DZ*bWs.W2L*Weight",True)
...
cMetSig = CutInfo( "MetSig" , Cuts["MetSig"],"hltWeight_Mu17Mu8_DZ*bWs.W2L*Weight",True)
...
fout = TFile.Open("out_cft_normtolumi_reg_blind.root", "recreate")
